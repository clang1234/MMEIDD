...
class DelibLayer(nn.Module):
   
    def __init__(self, d_model, heads, d_ff, dropout,
                 self_attn_type="scaled-dot"):
        super(DelibLayer, self).__init__()
        ...
        # Register self.mask as a buffer in DelibLayer, so
        # it gets DelibLayer's cuda behavior automatically.
...
class Delib(nn.Module):
    ...
    def __init__(self, num_layers, d_model, heads, d_ff, attn_type,
        ...
        self.transformer_layers = nn.ModuleList(
            [DelibLayer(d_model, heads, d_ff, dropout,
             self_attn_type=self_attn_type)
             for _ in range(num_layers)])

        # Delib has its own attention mechanism.
    ...
    def forward(self, tgt, memory_bank, memory_lengths=None, step=None):
        ...
        # Run the forward pass of the Delib.
